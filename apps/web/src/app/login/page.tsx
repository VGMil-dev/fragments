...
export default function LoginPage() {
  ...
  const loginWithSocial = async (provider: "google" | "github") => {
    await authClient.signIn.social({
      provider,
      callbackURL: `${process.env.NEXT_PUBLIC_API_URL ?? "http://localhost:3000"}/dashboard`,
    });
  };
        ...
        <div className="bento p-8 flex flex-col gap-6">
              ...
              <div
                ...
                onFocus={(e) => {
                  (e.currentTarget as HTMLElement).style.boxShadow =
                    "inset 0 0 0 1px rgba(217,70,239,0.4)";
                }}
                onBlur={(e) => {
                  (e.currentTarget as HTMLElement).style.boxShadow =
          ...
          <div className="flex flex-col gap-2.5">
            <button
              ...
              className="inline-flex items-center justify-center gap-2.5 w-full px-4 py-2.5 rounded-2xl text-sm font-medium transition-colors"
              style={{
                color: "var(--ink)",
